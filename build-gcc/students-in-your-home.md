...
provenance:
  ...
  sources:
    ...
    - id: ctax/rules@2.4.0+2.2:/executable_rule_slices/rules[rule_id=rule.discount.single_person]#a1b2c3d4
      ...
      used_for:
        - single_person_outcome_in_mixed_household
...
<!-- provenance: ctax/facts@2.4.0+2.2:/adjustment_catalogue/exemptions/items/student_household#your_situation#f1a2b3c4 -->
...
A property occupied only by full-time students pays nothing. The exemption applies for as long as the property is occupied exclusively by qualifying students — including during term-time vacations, as long as the property remains the students' main residence.

<div class="gcc-callout gcc-callout--success">
  <span class="gcc-callout__icon" aria-hidden="true">✓</span>
  <div class="gcc-callout__body">
    <p><strong>This applies even if you are renting from a private landlord.</strong> The exemption belongs to the occupants, not the building. As long as every resident aged 18 or over is a qualifying full-time student, there is no bill.</p>
  </div>
</div>
...
**Example:** You share a house with two full-time students. After disregarding both students, the adult count is 1 — you. Your bill is 75% of the Band D charge (£1,761.13 per year outside Quedgeley).

### There are two or more non-student adults

**Your bill: the full standard charge.**

Once there are two or more adults who are not disregarded, no occupant-based discount applies. The students are still invisible in the count — but with two counted adults remaining, no reduction is triggered.
...
You are disregarded. The bill is calculated as if you are not there. If only one non-student adult remains after all disregards, they get 25% off. If two or more non-students remain, full charge applies. You are not liable for Council Tax yourself while you are a full-time student.
...
Part-time students do not qualify — they count as adults.
...
<div class="gcc-callout gcc-callout--warning">
  <span class="gcc-callout__icon" aria-hidden="true">⚠</span>
  <div class="gcc-callout__body">
    <p><strong>Gap years.</strong> A student on a gap year or approved interruption of study may no longer qualify during that period. Contact us to check — rules vary depending on the institution's classification of the break.</p>
  </div>
</div>
...
**By email:** Send the student certificate to **revenues@gloucester.gov.uk** with your Council Tax account number. If applying for a full exemption, include certificates for every student at the address.
...
Tell us within **21 days**. The exemption or disregard ends on that date, and the standard charge (or reduced charge) begins. Failure to notify us may result in a backdated bill and a penalty of up to **£70**.

## The law behind this

The full exemption for student households is **Class N** of the **Council Tax (Exempt Dwellings) Order 1992**. The disregard for individual full-time students is in **Schedule 1, paragraph 4 of the Local Government Finance Act 1992**.
